...
const FormCollapseCom = observer(
  defineComponent({
    name: 'FormCollapseCom',
    ...
    setup(props, { attrs }) {
      ...
      const setActiveKey = (value: string | string[]) => {
...
export const FormCollapse = Object.assign(FormCollapseCom, {
  Behavior,
  Resource,
})
