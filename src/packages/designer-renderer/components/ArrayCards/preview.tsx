  ...
  defineComponent({
    ...
    setup(props, { slots }) {
      ...
      return () => {
        ...
        const designer = useDesignerRef.value
        // if (!node) return
...
const Behavior = createArrayBehavior('ArrayCards')
...
export const ArrayCards = Object.assign(ArrayCardsCom, {
  Behavior,
  Resource,
