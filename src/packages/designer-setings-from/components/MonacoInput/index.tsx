...
import { IconWidget, TextWidget, usePrefix, useTheme } from '@designer-main-body'
...
const MonacoInputInner = defineComponent({
  props: {
    language: { type: String as PropType<string>, default: undefined },
    defaultLanguage: { type: String as PropType<string>, default: undefined },
    width: { type: [String, Number], default: undefined },
    height: { type: [String, Number], default: undefined },
    helpLink: { type: [String, Boolean], default: undefined },
    helpCode: {
      type: String as PropType<MonacoInputProps['helpCode']>,
      default: undefined,
    },
    helpCodeViewWidth: { type: [String, Number], default: undefined },
    onMount: { type: Function, default: undefined },
    // onChange: { type: Function },
    value: {
      type: String as PropType<MonacoInputProps['value']>,
      default: undefined,
    },
    defaultValue: {
    ...
    extraLib: { type: String, default: undefined },
    options: {
      type: Object as PropType<MonacoInputProps | any>,
      default: undefined,
    },
  },
  emits: ['change'],
  ...
  setup(props, { attrs, emit }) {
    ...
    const onMountHandler = (
      ...
      if (currentValue) {
        try {
          const content = format(computedLanguage.value, currentValue)
...
export const MonacoInput = Object.assign(MonacoInputInner, {
  loader: loader,
})
